...
public class AVAILABLECOMPLEMENTARY extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(isNull(session)) {
            ...
            String programmeCode = request.getParameter("mnu_prg_code").trim();//getting the value of the program code from the browser
            ...
            String medium = request.getParameter("txt_medium").toUpperCase();//getting the medium  select by the user from the browser
            String currentSession = request.getParameter("txt_session").toLowerCase();//getting the value of the current session from the browser
            ...
            try {
                ...
                int[] stock = new int[totalLength];//int array for holding the stock available for all courses block wise
